...
function initDecodeJson():Function
{
   ...
   parse = {
      ...
      {
         param1 = param1.toXMLString() as String;
         if(!param1.toXMLString is Function || param1 == null)
         {
   ...
   return function(param1:Object, param2:IDataOutput = null, param3:Boolean = false, param4:Boolean = false):String
   {
      var byteOutput:* = undefined;
      var input:Object = param1;
      var writeTo:IDataOutput = param2;
      var strictNumberSupport:Boolean = param3;
      var allowNativeJson:Boolean = param4;
      ...
      try
      {
         ...
         if(allowNativeJson && strictNumberSupport && Boolean(nativeJson))
         {
