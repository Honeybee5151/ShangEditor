...
//editor8182381
import kabam.rotmg.messaging.impl.incoming.CustomGrounds;
//editor8182381
import kabam.rotmg.messaging.impl.incoming.CustomObjects;
...
public class GameServerConnection
   {
      ...
      //editor8182381 — Custom ground/object message IDs
      public static const CUSTOM_GROUNDS:int = 88;
      public static const CUSTOM_OBJECTS:int = 89;
      ...
      private function mapMessages() : void
      {
         ...
         //editor8182381 — Map custom ground/object messages (parsing done in message class)
         messages.map(CUSTOM_GROUNDS).toMessage(CustomGrounds).toMethod(this.onCustomGrounds);
         messages.map(CUSTOM_OBJECTS).toMessage(CustomObjects).toMethod(this.onCustomObjects);
      }
      ...
      //editor8182381 — Custom ground/object handlers (parsing already done in message parseFromInput)
      private function onCustomGrounds(_arg1:CustomGrounds):void {
         // All work done in CustomGrounds.parseFromInput → GroundLibrary.loadBinaryCustomGround
      }

      private function onCustomObjects(_arg1:CustomObjects):void {
         // All work done in CustomObjects.parseFromInput → GroundLibrary.loadBinaryCustomObject
      }
      ...
      {
         //editor8182381 — Clean up previous dungeon's custom data to prevent cross-dungeon memory leak
         GroundLibrary.clearCustomEntries();
