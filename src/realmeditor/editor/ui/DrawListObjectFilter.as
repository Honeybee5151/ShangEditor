package realmeditor.editor.ui
{
   ...
   public class DrawListObjectFilter implements IDrawElementFilter
   {
      ...
      public function DrawListObjectFilter()
      {
         props = {};
         super();
      }
      ...
      public function filter(elementType:int) : Boolean
      {
         ...
         for(var propName in this.props)
         {
            ...
            if(value && !xml.hasOwnProperty(propName) || !value && xml.hasOwnProperty(propName) || value && xml.hasOwnProperty(propName) && !ValuesMatch(xml,propName,value))
            {
               return false;
            }
         }
