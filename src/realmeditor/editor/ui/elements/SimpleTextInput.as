package realmeditor.editor.ui.elements
{
   ...
   public class SimpleTextInput extends Sprite
   {
      ...
      public function SimpleTextInput(title:String, inline:Boolean = false, inputText:String = "", titleSize:int = 18, titleColor:uint = 16777215, inputSize:int = 15, inputColor:uint = 15395562, stopKeyPropagation:Boolean = false)
      {
         super();
