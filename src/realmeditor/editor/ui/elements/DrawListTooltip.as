package realmeditor.editor.ui.elements
{
   ...
   public class DrawListTooltip extends Tooltip
   {
      ...
      {
         var size:Number = !!this.iconTexture ? 80 * (8 / this.iconTexture.width) : 1;
      ...
      {
         this.id = this.xml.@id;
         this.idText = new SimpleText(18,16777215);
      ...
      {
         this.propertiesText = new SimpleText(16,11711154);
         this.propertiesText.htmlText = this.properties;
         this.propertiesText.setAlignment("left");
