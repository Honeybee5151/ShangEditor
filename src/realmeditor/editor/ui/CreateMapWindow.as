package realmeditor.editor.ui
{
   ...
   public class CreateMapWindow extends MEWindow
   {
      ...
      {
         super("New Map");
         this.inputName = new SimpleTextInput("Name:",true,"",18,16777215,15,15395562,true);
         this.inputName.setWidth(110);
         this.inputName.inputText.restrict = "a-z A-Z 0-9";
         addChild(this.inputName);
         this.inputWidth = new SimpleTextInput("Width:",true,"",18,16777215,15,15395562,true);
         this.inputWidth.inputText.restrict = "0-9";
         addChild(this.inputWidth);
         this.inputHeight = new SimpleTextInput("Height:",true,"",18,16777215,15,15395562,true);
      ...
      override protected function onOkClick(e:Event) : void
      {
         super.onOkClick(e);
         ...
         this.dispatchEvent(new Event("MapCreate"));
         this.visible = false;
      }
