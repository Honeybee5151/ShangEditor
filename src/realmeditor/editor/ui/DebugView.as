package realmeditor.editor.ui
{
   ...
   public class DebugView extends Sprite
   {
      ...
      public function DebugView()
      {
         ...
         this.fpsText = new SimpleText(16,16777215);
         this.fpsText.setText("FPS: 0");
         this.fpsText.updateMetrics();
         addChild(this.fpsText);
         this.memoryText = new SimpleText(16,16777215);
      ...
      {
         var fps:int = 0;
         var memory:Number = NaN;
         if(this.statsCooldown == 0)
         {
            fps = 1000 / deltaTime;
            this.fpsText.setText("FPS: " + fps);
            memory = System.privateMemory / 1000000;
