package realmeditor.editor.ui
{
   ...
   public class ObjectFilterOptionsView extends Sprite
   {
      ...
      public function ObjectFilterOptionsView(listView:MapDrawElementListView)
      {
         ...
         this.arrowText = new SimpleText(20,16777215);
         ...
         this.arrowText.addEventListener("click",this.onArrowClick);
      ...
      private static function IsNumber(str:String) : Boolean
      {
         var i:int = 0;
         var c:String = null;
         for(i = 0; i < "abcdefghijklmopuqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".length; )
         {
            c = "abcdefghijklmopuqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(i);
            if(str.indexOf(c) != -1)
            {
               return false;
            }
      ...
      {
         this.propInput = new SimpleTextInput("Property:",true,"",18,16777215,15,15395562,true);
         ...
         this.valueInput = new SimpleTextInput("Value:",true,"",18,16777215,15,15395562,true);
      ...
      {
         var val:* = !this.background.visible;
      ...
      private function onAddClick(e:Event) : void
      {
         ...
         if(propName == "" || Boolean(this.options.hasOwnProperty(propName)))
         {
            return;
         }
         if(valueStr == "")
      ...
      private function positionOptions() : void
      {
         ...
         for(var propName in this.options)
         {
            ...
            this.options[propName].y += i * 30 + i * 2;
            i++;
         }
      }
...
class FilterOption extends Sprite
{
   ...
   public function FilterOption(propName:String, val:*)
   {
      ...
      this.propText = new SimpleText(18,16777215);
      ...
      this.valText = new SimpleText(18,16777215);
