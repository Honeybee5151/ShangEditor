package realmeditor.assets
{
   ...
   public class ObjectProperties
   {
      ...
      public function ObjectProperties(objectXML:XML)
      {
         ...
         this.shadowSize_ = !!objectXML.hasOwnProperty("ShadowSize") ? int(objectXML.ShadowSize) : 100;
         ...
         this.oldSound_ = !!objectXML.hasOwnProperty("OldSound") ? String(objectXML.OldSound) : null;
         this.angleCorrection_ = !!objectXML.hasOwnProperty("AngleCorrection") ? Number(objectXML.AngleCorrection) * 3.141592653589793 / 4 : 0;
         this.rotation_ = !!objectXML.hasOwnProperty("Rotation") ? Number(objectXML.Rotation) : 0;
...
class WhileMovingProperties
{
   ...
   public function WhileMovingProperties(whileMovingXML:XML)
   {
      super();
